        ...
        if person and is_pin_valid(person, pin_code):
            while True:
                try:
                    ...
                    print("Необходимо выбрать пункт 1, 2 или 3!")
...
# не разобралась, почему функция - process_user_choice(choice, person) - не начинает работать и что не так с переменной choice ..